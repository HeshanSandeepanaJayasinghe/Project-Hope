...
const NewVerifier = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await authAxios.post('/admin/register/verifier', {
      ...
      const message = error.response?.data?.message || error.response?.data?.Message || 'Failed to create verifier';
      toast.error(message);
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="admin-layout">
      ...
      <div className="new-verifier-container">
        <button 
          ...
          <form onSubmit={handleSubmit} className="verifier-form">
            ...
            <div className="form-group">
              ...
              <div className="input-wrapper">
                <User size={20} className="input-icon-verifier-form" />
                <input
                  type="text"
                  name="firstName"
                  placeholder="John"
            ...
            <div className="form-group">
              ...
              <div className="input-wrapper">
                <Mail size={20} className="input-icon-verifier-form" />
                <input
                  type="email"
                  name="email"
            ...
            <div className="form-group">
              ...
              <div className="input-wrapper">
                <Phone size={20} className="input-icon-verifier-form" />
                <input
                  type="tel"
                  name="phoneNumber"
                  placeholder="5869241070"
            ...
            <div className="form-group">
              ...
              <div className="input-wrapper">
                <Lock size={20} className="input-icon-verifier-form" />
                <input
