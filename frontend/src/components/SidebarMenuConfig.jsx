...
export const MENU_CONFIG = {
    ...
    verifier: [
        ...
        { id: 'verifierViewProfile', label: 'View Profile', path: '/verifier/view-profile', icon: <UserRoundPen size={20} /> },
    ...
    recipient: [
        ...
        { id: 'recipientViewProfile', label: 'View Profile', path: '/recipient/view-profile', icon: <UserRoundPen size={20} /> },
    ...
    donor: [
        ...
        { id: 'donorViewProfile', label: 'View profile', path: '/donor/view-profile', icon: <UserRoundPen size={20} /> },
